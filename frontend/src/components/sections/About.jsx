                    ...
                    <div className="flex flex-col md:flex-row items-center gap-12">
                        <div className="md:w-1/3">
                            <div className="aspect-square rounded-2xl overflow-hidden shadow-lg bg-gray-100 dark:bg-neutral-800 relative group">
                                ...
                                />
                                <div className="absolute inset-0 bg-primary/10 dark:bg-primary/5 group-hover:bg-transparent transition-colors duration-300"></div>
                            </div>
                        </div>
                        ...
                        <div className="md:w-2/3">
                            ...
                            <div className="flex flex-wrap gap-4 mb-8">
                                {['Web Development', 'UI/UX Design', 'API Integration', 'Database Management'].map((skill) => (
                                    <span key={skill} className="px-4 py-2 bg-gray-100 dark:bg-neutral-800 text-gray-700 dark:text-gray-300 rounded-full text-sm font-medium border border-transparent dark:border-neutral-700 transition-colors">
                                        {skill}
                                    </span>
                                ))}
                            </div>
